...
module.exports = defineConfig({
  ...
  reporter: [
    ['html', { outputFolder: '.artifacts/test-results/playwright-report' }],
    ['junit', { outputFile: '.artifacts/test-results/playwright-results.xml' }],
  ...
  /* Output directories */
  outputDir: '.artifacts/test-results/playwright-traces',
});