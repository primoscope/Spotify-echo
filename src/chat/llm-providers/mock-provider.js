...
class MockLLMProvider extends BaseLLMProvider {
  ...
  handleError(error) {
    ...
    return {
      ...
      content:
        "I'm having a small hiccup, but I'm still here to help! What kind of music are you interested in exploring today?",
