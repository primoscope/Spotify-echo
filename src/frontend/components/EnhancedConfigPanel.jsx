...
function EnhancedConfigPanel() {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case 'healthy': case 'running': return <CheckCircle color="success" />;
      case 'warning': return <Warning color="warning" />;
      case 'error': case 'unhealthy': return <Error color="error" />;
      default: return <Refresh color="action" />;
    }
  };
            ...
            <CardContent>
              ...
              <FormControl fullWidth margin="normal">
                ...
                <Select
                  ...
                  onChange={(e) => setConfig(prev => ({ ...prev, recommendationEngine: e.target.value }))}
                >
              ...
              <FormControl fullWidth margin="normal">
                ...
                <Select
                  ...
                  onChange={(e) => setConfig(prev => ({ ...prev, discoveryMode: e.target.value }))}
                >
              ...
              <Typography gutterBottom sx={{ mt: 2 }}>Audio Quality</Typography>
              <Slider
                value={config.audioQuality === 'high' ? 100 : config.audioQuality === 'medium' ? 50 : 25}
                onChange={(e, value) => {
        ...
        <Grid item xs={12} md={6}>
          <Card>
            <CardContent>
              ...
              <Typography gutterBottom sx={{ mt: 2 }}>Request Timeout (seconds): {config.requestTimeout}</Typography>
              <Slider
              ...
              <Typography gutterBottom sx={{ mt: 2 }}>Batch Size: {config.batchSize}</Typography>
              <Slider
            ...
            <CardContent>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                ...
                <Switch
                  ...
                  onChange={(e) => setConfig(prev => ({ ...prev, anonymousMode: e.target.checked }))}
                />
              </Box>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                ...
                <Switch
                  ...
                  onChange={(e) => setConfig(prev => ({ ...prev, dataCollection: e.target.checked }))}
                />
              </Box>
      ...
      <Dialog open={saveDialog} onClose={() => setSaveDialog(false)}>
        ...
        <DialogContent>
          <Alert severity="success">
            Your configuration has been saved successfully. Some changes may require an application restart to take effect.
          </Alert>
        </DialogContent>
        <DialogActions>
